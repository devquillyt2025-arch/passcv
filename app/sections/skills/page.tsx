...
export default function SkillsPage() {
  ...
  const skills = edited?.skills?.join(', ') || '';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0A0A0F] text-gray-900 dark:text-white transition-colors duration-200">
      <div className="max-w-3xl mx-auto py-8 px-4">
        ...
        <textarea
          ...
          className="w-full h-36 rounded-lg border border-gray-300 dark:border-white/20 bg-white dark:bg-[#13131A] text-gray-900 dark:text-white p-3 text-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none placeholder:text-gray-400 dark:placeholder:text-gray-600"
        />
      </div>
    </div>
  );
